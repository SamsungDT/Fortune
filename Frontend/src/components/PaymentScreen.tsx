        ...
        {paymentStep === "confirm" && (
          <Card className="hanji-texture border border-hanbok-gold/30 p-6 rounded-3xl ink-shadow">
            <div className="text-center mb-6">
              ...
              <h1 className="text-xl text-ink-black dark:text-ink-gray mb-3 ink-brush">
                {service.name} 이용
              </h1>
            ...
            <div className="space-y-4 mb-6">
              <div className="flex justify-between items-center">
                ...
                <span className="text-ink-black dark:text-ink-gray font-medium">
                  {service.name}
                </span>
              </div>
              ...
              <div className="flex justify-between items-center text-lg">
                <span className="text-ink-black dark:text-ink-gray font-semibold">
                  총 결제금액
                </span>
                <span className="text-hanbok-gold-dark font-bold">
                  {service.price.toLocaleString()}원
                </span>
              </div>
            </div>
            ...
            <Card className="border border-dancheong-green/30 bg-dancheong-green/5 p-4 mb-6 rounded-2xl">
              <h3 className="text-ink-black dark:text-ink-gray mb-3 ink-brush flex items-center">
                <Gift className="w-4 h-4 mr-2 text-dancheong-green" />첫 이용
                혜택
              </h3>
          ...
          <Card className="hanji-texture border border-hanbok-gold/30 p-8 rounded-3xl ink-shadow">
            <div className="text-center space-y-6">
              ...
              <div className="space-y-3">
                ...
                />
                <p className="text-hanbok-gold-dark font-medium">
                  {progress}% 완료
                </p>
              </div>
