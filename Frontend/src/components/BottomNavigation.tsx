          ...
          {navigationItems.map((item) => {
            ...
            return (
              <Button
                ...
                className={`group flex flex-col items-center gap-2 p-3 h-auto rounded-2xl min-w-0 flex-1 relative transition-all duration-300 ${
                  isActive 
              ...
              >
                ...
                <span className={`text-xs truncate w-full text-center font-medium transition-all duration-300 ${
                  isActive ? 'text-hanbok-gold-dark' : ''
                }`}>
                  {item.label}
                </span>
